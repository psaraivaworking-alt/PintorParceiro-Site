...
function showMessage(msg, isError = false) {
    ...
    if (messageBox) {
        ...
        if (isError) {
            ...
            messageBox.classList.remove('error-message'); // Corrigido 'error-error-message' para 'error-message'
        }
        setTimeout(() => {
...
if (registerForm) {
    ...
    registerForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            console.error("Erro completo da operacao Firebase:", error); // LOG O OBJETO DE ERRO COMPLETO
            const errorCode = error.code;
            const errorMessage = error.message;

            console.log("Firebase Error Code (codigo do erro):", errorCode);   // LOG O CÓDIGO DO ERRO
            console.log("Firebase Error Message (mensagem do erro):", errorMessage); // LOG A MENSAGEM DO ERRO
